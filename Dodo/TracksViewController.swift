...
class TracksViewController: UITableViewController, IndicatorInfoProvider {
    ...
    override func viewDidLoad() {
        ...
        self.refreshControl?.addTarget(self, action: #selector(TracksViewController.refresh), forControlEvents: .ValueChanged)
        self.refresh()
    }
    ...
    private func calculateTrackProgress() {
        for track in self.tracks {
            ...
            let current_stage = track.stages[current_stage_idx].honor_title
